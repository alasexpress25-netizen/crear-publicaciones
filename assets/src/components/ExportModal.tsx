    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-md">
      ...
      <div className="relative w-full max-w-xl bg-slate-900 border border-slate-800 rounded-2xl shadow-2xl flex flex-col overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="p-6 space-y-3.5">
          {/* Action 0: Video Render (Clipchamp Style) */}
          {onOpenVideoExport && (
            <button
              onClick={() => {
                onClose();
              ...
              className="w-full flex items-center justify-between p-4 bg-gradient-to-r from-rose-950/70 to-pink-950/70 hover:from-rose-900/80 hover:to-pink-900/80 border border-rose-600/50 rounded-xl transition text-left group shadow-lg shadow-rose-950/50 cursor-pointer"
            >
              <div className="flex items-center gap-3.5">
                <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-rose-600 to-pink-600 flex items-center justify-center text-white shadow-md group-hover:scale-105 transition">
                  <Film className="w-5 h-5" />
                </div>
                <div>
                  <h4 className="text-sm font-bold text-white flex items-center gap-2">
                    <span>Renderizar Video Profesional (MP4 / WebM)</span>
                    <span className="text-[10px] bg-rose-600 text-white font-black px-2 py-0.5 rounded-full">
                      CLIPCHAMP
                    </span>
                  </h4>
                  <p className="text-xs text-rose-200/80">
                    Video fluido con transiciones, efectos de cámara y música (16:9 TV, 9:16 Reel, 4:5 Feed)
                  </p>
                </div>
              </div>
              <span className="text-xs bg-rose-600 text-white font-black px-3 py-1.5 rounded-lg shadow">
                Renderizar Video
              </span>
            </button>
          )}
