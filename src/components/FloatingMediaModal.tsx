  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={`flex items-center justify-between px-3.5 py-2.5 bg-slate-950/80 border-b border-slate-800 rounded-t-2xl cursor-grab active:cursor-grabbing shrink-0 ${
      ...
      {!isMinimized && (
        <div className="flex-1 min-h-0 overflow-y-auto custom-scrollbar p-2.5 sm:p-3 select-text bg-slate-900/60 rounded-b-2xl">
          <MediaPanel
            slide={slide}
            slides={slides}
